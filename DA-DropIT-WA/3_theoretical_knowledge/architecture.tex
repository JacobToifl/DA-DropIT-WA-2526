...
Die folgende Tabelle stellt die in der Praxis wichtigsten Unterschiede zwischen lexikalischer, semantischer und hybrider Suche gegenüber.

\begin{table}[h]
    \centering
    \renewcommand{\arraystretch}{1.5} % Zeilenabstand für bessere Lesbarkeit
