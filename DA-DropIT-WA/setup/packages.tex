...
\WarningFilter{longtable}{Infinite glue shrinkage}
...
\usepackage{tabularx}      % für die .env-Tabelle
\usepackage{booktabs}      % für \toprule, \midrule, \bottomrule
\usepackage{float}         % für [H] bei Tabellen
\usepackage{tcolorbox}     % für die Important/Warning-Boxen
\usepackage{fontawesome}   % für \faExclamationTriangle
\usepackage{listings}      % für den bash-Codeblock
